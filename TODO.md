...
- Consider adding an `apply({...})` config/object-based browser entrypoint for immediate batch DOM processing, instead of requiring several separate class-oriented helper calls.
